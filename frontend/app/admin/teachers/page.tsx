        ...
        try {
            ...
            if (editingTeacher) {
                ...
                if (result.generatedPassword) {
                    alert(`الأستاذ تم إنشاؤه بنجاح!\nالبريد الإلكتروني: ${result.email || 'غير محدد'}\nكلمة المرور: ${result.generatedPassword}\n\nيرجى نسخ كلمة المرور وإعطائها للأستاذ.`);
                }
            }
            fetchTeachers();
                        ...
                        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 mt-1 ml-1">Email pour l'accès au système</p>
                                </div>

                                <div>
                                    <label className="label font-bold text-blue-700 dark:text-yellow-400">
                                        {editingTeacher ? 'Nouveau mot de passe (optionnel)' : 'Mot de passe'}
                                        {!editingTeacher && ' *'}
                                    </label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            placeholder={editingTeacher ? "Laisser vide pour garder l'ancien" : "Mot de passe automatique si vide"}
                                        />
                                    </div>
                                    {!editingTeacher && (
                                        <p className="text-xs text-gray-400 mt-1 ml-1">Si vide, un mot de passe sera généré automatiquement</p>
                                    )}
                                </div>
                                <div>
